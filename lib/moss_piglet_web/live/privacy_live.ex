          ...
          <div class="mt-12 prose prose-lg prose-emerald max-w-none">
            <section class="mb-12">
              ...
              <p class="text-gray-600">
                We respect your privacy. We don't sell your data. We don't share it with
                advertisers. We don't participate in surveillance capitalism. Period.
              </p>
            ...
            <section class="mb-12">
              ...
              <p class="text-gray-600">
                Moss Piglet Corporation is a Delaware Public Benefit Corporation building privacy
                software for the post-quantum era. We ship zero-knowledge encrypted software,
                open-source cryptographic libraries, and privacy-first SaaS products.
              </p>
            </section>
            ...
            <section class="mb-12">
              ...
              <p class="text-gray-600 mb-4">
                We only collect information that helps us serve you:
              </p>
              <ul class="list-disc pl-6 text-gray-600 space-y-2">
                <li>
                  <strong>Contact information</strong>
                  you provide (like your name, email, and company) when you submit our intake
                  form or reach out to us
                </li>
                <li>
              ...
              <p class="text-gray-600 mt-4">
                Our intake form does not store your submission in a database. It sends an email
                directly to our team via encrypted email (Proton Mail) and nothing is retained
                on our servers.
              </p>
            </section>
            ...
            <section class="mb-12">
              ...
              <ul class="list-disc pl-6 text-gray-600 space-y-2">
                ...
                <li>
                  <strong>Track you across the web</strong>
                  — we don't use cookies or invasive tracking
                </li>
                <li>
            ...
            <section class="mb-12">
              ...
              <ul class="list-disc pl-6 text-gray-600 space-y-2">
                <li>
                  Our SaaS products use a three-layer encryption model: LUKS disk encryption,
                  AES-256-GCM at rest, and zero-knowledge application-layer encryption
                </li>
                <li>
                  Post-quantum key encapsulation (ML-KEM-768/1024, FIPS 203) across our products
                </li>
                <li>All cryptographic code is open source and auditable</li>
            ...
            <section class="mb-12">
              ...
              <p class="text-gray-600 mt-4">
                Just email us at <a
                  ...
                  phx-no-format
                >
                  privacy@mosspiglet.dev</a> and we'll take care of it.
              </p>
            </section>
            ...
            <section class="mb-12">
              ...
              <ul class="list-disc pl-6 text-gray-600 space-y-2">
                <li>
                  <strong>Proton Mail</strong> — encrypted email
                </li>
                <li>
                  <strong>Mailgun</strong>
                  — email delivery (TLS required, all tracking disabled, 1-day message retention)
                </li>
                <li>
              ...
              <p class="text-gray-600 mt-4">
                We choose partners who share our commitment to privacy and never share more
                information with them than absolutely necessary.
              </p>
            </section>
            ...
            <section class="mb-12">
              ...
              <p class="text-gray-600">
                If we make significant changes to this policy, we'll let you know. We won't
                quietly slip in new ways to use your data. That's not how we operate.
              </p>
            </section>
